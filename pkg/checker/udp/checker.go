...
// Checker sends an UDP ECHO request and checks if a reply is returned.
type Checker struct {
	prober      *Prober
	outputType  string
	outputValue []string
...
// isValidUDPAddr  tells if s is a valid Udp address or not.
func isValidUDPAddr(s string) bool {
