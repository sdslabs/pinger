...
// InspectContainer returns container information by using containerID
...
func (cli DockerClient) ListContainers(ctx context.Context) ([]string, error) {
...
func (cli DockerClient) BuildImage(ctx context.Context)
